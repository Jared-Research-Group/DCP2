...
def regress(data, d,  niterations=1000, totalIterations=500000, checkpointPath=None ):
    ...
    if checkpointPath is not None:
        ...
        model = model.from_file(checkpointPath, warm_start=True)
        print(model.get_pkl_filename())
